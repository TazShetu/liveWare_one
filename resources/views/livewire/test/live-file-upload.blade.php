...
<section>
    <div class="container m-5">
        ...
        @endif
        <form class="row g-3" wire:submit.prevent="addComment" enctype="multipart/form-data">
            <div class="col-md-2">
            ...
            <div class="col-auto">
                <input type="file" wire:model="inputImage">
                @error('inputImage')
        ...
        {{--            preview     --}}
        <div wire:loading wire:target="inputImage">Uploading...</div>
        @if ($inputImage)
            <img src="{{ $inputImage->temporaryUrl() }}" style="max-width: 200px; max-height: 200px;">
        @endif
